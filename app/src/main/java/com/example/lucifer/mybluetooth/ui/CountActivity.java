...
import com.example.lucifer.mybluetooth.db.MyDatabaseHelper;
import com.example.lucifer.mybluetooth.R;
import com.example.lucifer.mybluetooth.http.GlobalConfig;
...
public class CountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new MyDatabaseHelper(this, GlobalConfig.DATABASE_NAME, null, 2);
